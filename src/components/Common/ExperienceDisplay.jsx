      ...
      <div className="ps-2 my-2 first:mt-0">
        ...
        />
         <input
          ...
          className="w-full mt-1 text-sm text-gray-600 dark:text-gray-400 pb-1 border-b border-gray-300 focus:outline-none focus:border-blue-500 disabled:bg-white disabled:border-0 disabled:pb-0"
        />
      </div>
