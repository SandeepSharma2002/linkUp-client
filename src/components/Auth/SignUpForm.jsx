...
import logo from "../../imgs/blog-transparent.png";
...
export const SignUpForm = () => {
  ...
  const sendOtp = () => {
    ...
    setLoading(true);
    const id = toast.loading("Sending otp...", { autoClose: 2000 });
    auth
      .sendotp({ email })
      .then((res) => {
        toast.update(id, {
        ...
        <div className="mb-3 hidden sm:flex">
          ...
          >
            ...
            <path
              ...
              opacity="0.1"
            />
            <ellipse cx="313.7" cy="714.18" rx="33.8" ry="6.5" fill="#3b82f6" />
            <ellipse
              cx="313.13"
              cy="711.42"
              rx="3.94"
            ...
            <path
              ...
              fill="#f75842"
            />
            <circle cx="473" cy="60" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="520" cy="195" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="387" cy="67" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="172" cy="386" r="18" fill="#3b82f6" opacity="0.1" />
            <circle cx="897" cy="100" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="905" cy="195" r="23" fill="#3b82f6" opacity="0.1" />
            <circle cx="942" cy="130" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="880" cy="258" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="459" cy="116" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="197" cy="470" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="186" cy="310" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="570" cy="53" r="7" fill="#3b82f6" opacity="0.1" />
            <circle cx="593" cy="116" r="7" fill="#3b82f6" opacity="0.1" />
          </svg>
        </div>
