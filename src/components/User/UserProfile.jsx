...
export const UserProfile = () => {
  ...
  return loading ? (
    ...
    >
      <div
        class="pl-16 h-[64px] flex justify-between items-center px-4  border-b w-full sticky z-40 bg-gray-light dark:bg-bg-dark dark:border-text-l-500
      top-0 left-0 border-gray-dark dark:bg-bg-dark-1"
      >
        <p class="text-xl font-bold text-primary-600">Profile</p>
        <button class="text-sm font-medium text-blue-700 focus:outline-none focus:ring-1 dark:text-gray-light">
          Profile Settings
        </button>
      </div>
      <div className="px-6">
        <div className=" mx-auto ">
          <div className="xl:w-full border-b border-gray-dark dark:border-text-l-500 py-5">
            <div className="flex items-center">
              <p className="text-lg text-primary-600 font-bold">
                Profile
              </p>
              <div className="ml-2 cursor-pointer text-text-l-500 dark:text-gray-light">
                <svg
              ...
              <div className="mt-16  grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                <div className="flex flex-col">
                  <div className="flex flex-col w-full">
                    <label
                      htmlFor="username"
                      className="pb-2 text-sm font-bold text-text-l-600 dark:text-white"
                    >
                      Username
                    </label>
                    <input
                      ...
                      name="username"
                      required
                      className="border border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-600 bg-transparent placeholder-gray-500 text-gray-500 dark:text-gray-light"
                      placeholder="@example"
                    />
                  </div>
                  <div className="mt-4 flex-1 flex flex-col w-full">
                    ...
                    <textarea
                      ...
                      required
                      // value={userData?.bio}
                      className="bg-transparent border flex-1 border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-600 resize-none placeholder-gray-500 text-gray-500 dark:text-gray-light"
                      placeholder="Let the world know who you are"
                      defaultValue={""}
                    />
                    <p className="w-full text-right text-xs pt-1 text-gray-500 dark:text-gray-light">
                      Character Limit: 200
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div className="h-fit flex">
                      ...
                      <input
                        ...
                        id="github"
                        name="github"
                        className="pl-3 py-3 w-full text-sm border-y border-r border-gray-dark focus:outline-none placeholder-gray-500 rounded-y rounded-r bg-transparent text-gray-500 dark:text-gray-light dark:border-text-l-500"
                        placeholder=""
                      />
                    </div>
                  </div>
        ...
        <div className=" mx-auto  mt-4 rounded">
          <div className="xl:w-full border-b border-gray-dark dark:border-text-l-500 py-5">
            <div className="flex items-center">
              <p className="text-lg text-gray-800 dark:text-gray-100 font-bold text-primary-600">
            ...
            <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  name="firstName"
                  required
                  className="border border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:text-gray-light dark:border-text-l-500"
              ...
              <div className="flex flex-col">
                ...
                <div className="border border-gray-dark shadow-sm rounded flex dark:border-text-l-500">
                  <div className="px-4 py-3 dark:text-gray-100 flex items-center border-r border-gray-dark dark:border-text-l-500">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-mail dark:text-gray-light"
                      width={20}
                      height={20}
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                  ...
                  <input
                    ...
                    name="email"
                    required
                    className="pl-3 py-3 w-full text-sm focus:outline-none placeholder-gray-500 rounded bg-transparent text-gray-500 dark:text-gray-light dark:border-text-l-500"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  required
                  id="contactNumber"
                  className="bg-transparent border border-gray-dark pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:text-gray-light dark:border-text-l-500"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  name="streetAddress"
                  required
                  className="border border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm rounded bg-transparent text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:text-gray-light"
              ...
              <div className="flex flex-col">
                ...
                <div className="border border-gray-dark dark:border-text-l-500 shadow-sm rounded flex">
                  <input
                    ...
                    name="city"
                    required
                    className="pl-3 py-3 w-full text-sm focus:outline-none border border-transparent focus:border-blue-600 bg-transparent rounded placeholder-gray-500 text-gray-500 dark:text-gray-light"
                    placeholder="Enter City"
                  />
                  {/* <div className="px-4 flex items-center border-l border-gray-dark dark:border-text-l-500 flex-col justify-center text-gray-500 dark:text-gray-light">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  name="state"
                  required
                  className="border border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:text-gray-light"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  name="country"
                  required
                  className="border bg-transparent border-gray-dark dark:border-text-l-500 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:text-gray-light"
              ...
              <div className="flex flex-col">
                <div className="flex items-center pb-2">
                  <label
                    htmlFor="zipCode"
                    className="text-sm font-bold text-text-l-600 dark:text-white"
                  >
                    ZIP/Postal Code
                  </label>
                  <div className="ml-2 cursor-pointer text-text-l-500 dark:text-gray-light dark:border-text-l-500">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width={16}
                ...
                <input
                  ...
                  required
                  id="zipCode"
                  className="bg-transparent border border-gray-dark pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-600 placeholder-gray-500 text-gray-500 dark:border-text-l-500 dark:text-gray-light"
        ...
        <div className=" mx-auto w-11/12 xl:w-full">
          <div className="w-full py-4 sm:px-0 flex justify-end">
            <button className="bg-danger text-white focus:outline-none transition duration-150 ease-in-out hover:bg-gray-dark dark:bg-text-l-500 rounded text-indigo-600 dark:text-indigo-600 px-6 py-2 text-xs mr-4">
              Cancel
            </button>
            <button
              className="bg-primary-600 focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-2 text-sm"
              type="button"
            >
              Save
            </button>
        ...
        {/* <div className=" mx-auto mt-10 rounded bg-gray-100 dark:bg-text-l-500 w-11/12 xl:w-full">
                    ...
                    <div className="flex items-center mx-auto">
                        <div className=" mx-auto">
                            <div className="mx-auto xl:w-full">
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-light pt-1">Get updates of any new activity or features. Turn on/off your preferences</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className=" mx-auto pb-6">
                    <div className="flex items-center pb-4 border-b border-gray-dark dark:border-text-l-500 px-8 text-gray-800 dark:text-gray-100">
                    ...
                    <div className="px-8">
                        <div className="flex justify-between items-center mb-8 mt-4">
                            <div className="w-9/12">
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-light">Get notified when a post or comment is made</p>
                            </div>
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle1" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                        <div className="flex justify-between items-center mb-8">
                            <div className="w-9/12">
                                <p className="text-sm text-gray-800 dark:text-gray-100 pb-1">Job Applications</p>
                                <p className="text-sm text-gray-500 dark:text-gray-light">Get notified when a candidate applies to a job posting</p>
                            </div>
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle2" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                        <div className="flex justify-between items-center mb-8">
                            <div className="w-9/12">
                                <p className="text-sm text-gray-800 dark:text-gray-100 pb-1">Product Updates</p>
                                <p className="text-sm text-gray-500 dark:text-gray-light">Get notifitied when there is a new product feature or upgrades</p>
                            </div>
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle3" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                    </div>
                    <div className="pb-4 border-b border-gray-dark dark:border-text-l-500 px-8">
                    ...
                    <div className="px-8">
                        <div className="flex justify-between items-center mb-8 mt-4">
                            ...
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle4" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                        <div className="flex justify-between items-center mb-8">
                            <div className="w-9/12">
                            ...
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle5" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                        <div className="flex justify-between items-center mb-8">
                            <div className="w-9/12">
                            ...
                            <div className="cursor-pointer rounded-full bg-gray-200 relative shadow-sm">
                                ...
                                <label htmlFor="toggle6" className="toggle-label block w-12 h-4 overflow-hidden rounded-full bg-gray-dark dark:bg-gray-800 cursor-pointer" />
                            </div>
                        </div>
                    </div>
                </div>
